...
an9ther very commonly used address vwrification tool is called Addressbase and is made available by https://osdatahub.os.uk/ OS Places API, 

Here is the working REST API enricher:

METHOD: GET
URL: https://api.os.uk/search/places/v1/find?key={APIKey}&query={Vocabulary:address.fullAddress}%20{Vocabulary:address.locality}&maxresults=1&matchprecision=1
